export let PROFILES = [
  {
    ...
    desc: [
      ...
      "Matt co-founded the Life in Christ Prayer Group in 2017, a Parish Ministry in Chapel Hill through which he continues to evangelize the Good News and intercede for the anointing of the Holy Spirit within local Parish and Diocesan circles. In 2019, he assumed Leadership for the Annual Parish Retreat in St. Thomas More Catholic Church, Chapel Hill NC, where he continues to lead a core committee in spreading the message of God’s love and mercy."
    ]
  },
  {
    name: "Joe Zannini",
